...
TOOLS_SUCCESS = 0
TOOLS_CRASHED = 1
TOOLS_INVALID_COMMAND = 2
TOOLS_MODULE_TRACEBACK = 3
TOOLS_FILE_NOT_FOUND = 4

PFM_INDEED = 0
PFM_NOT_A_MODIFIER = 1
PFM_NO_CLASS = 2
PFM_AST_CRASHED = 3

PFM_BASES = ("ptModifier", "ptMultiModifier", "ptResponder", "ptModifierEx")
